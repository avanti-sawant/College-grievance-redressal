...
import com.college.fragment.SeeFacultyApproveFragment;
import com.college.fragment.SeeParentApproveFragment;
import com.college.fragment.SeeStudentApproveFragment;
...
public class ShowApproval extends AppCompatActivity {

    TabLayout tabLayout;
    ViewPager viewPager;
    private SeeParentApproveFragment parentFragment;
    private SeeStudentApproveFragment studentFragment;
    private SeeFacultyApproveFragment facultyFragment;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_approval);
        ...
        parentFragment= new SeeParentApproveFragment();
        studentFragment = new SeeStudentApproveFragment();
        facultyFragment = new SeeFacultyApproveFragment();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent=new Intent(ShowApproval.this,AdminMenu.class);
