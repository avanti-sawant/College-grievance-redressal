...
public class SeeFacultyPostGrievance extends AppCompatActivity {
    RecyclerView recycler_see_grievence_details;
    ArrayList<GrievenceDetail> seeGrievenceDetails=new ArrayList<>();
    FacultyGrievanceDetailsAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_see_faculty_post_grievance);
        ...
        seeGrievenceDetails.add(new GrievenceDetail("John Mathew","lorem ipsum",
                "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod" +
                        ...
                        "consequat.","Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                "Pending","08-10-2021 10:24","Rahul Mathew","9874561230"));*/
        LinearLayoutManager layoutManager=new LinearLayoutManager(SeeFacultyPostGrievance.this);
        recycler_see_grievence_details.setLayoutManager(layoutManager);
        recycler_see_grievence_details.setHasFixedSize(true);
        /*adapter=new FacultyGrievanceDetailsAdapter(SeeFacultyPostGrievance.this,seeGrievenceDetails);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Keys.Common.GET_MY_GRIEVENCE, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(SeeFacultyPostGrievance.this, json.getString("message"), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SeeFacultyPostGrievance.this, "Check internet connection", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("g_type", "3");
                params.put("g_u_id", SharedPreference.get("f_id"));
                return params;
            }
        };
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent=new Intent(SeeFacultyPostGrievance.this, FacultyMenu.class);
...
class FacultyGrievanceDetailsAdapter extends RecyclerView.Adapter<FacultyGrievanceDetailsAdapter.ViewHolder> {
    ...
    public FacultyGrievanceDetailsAdapter(Context context, ArrayList<GrievenceDetail> list) {
    ...
    @NonNull
    @Override
    public FacultyGrievanceDetailsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FacultyGrievanceDetailsAdapter.ViewHolder(listItem);
    }

    @Override
    public void onBindViewHolder(@NonNull FacultyGrievanceDetailsAdapter.ViewHolder holder, int position) {
