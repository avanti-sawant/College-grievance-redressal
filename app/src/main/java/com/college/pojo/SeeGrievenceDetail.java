...
public class SeeGrievenceDetail {
    /*private String name;
    ...
    */
    ...
    public SeeGrievenceDetail(String g_id, String g_type, String g_u_id, String gs_id, String g_name, String g_phone, String g_description, String g_photo, String g_reply_id, String g_reply, String g_time) {
        this.g_id = g_id;
        this.g_type = g_type;
        this.g_u_id = g_u_id;
        this.gs_id = gs_id;
